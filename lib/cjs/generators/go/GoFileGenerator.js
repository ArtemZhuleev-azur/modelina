...
exports.GoFileGenerator = void 0;
const GoGenerator_1 = require("./GoGenerator");
const path = __importStar(require("path"));
const helpers_1 = require("../../helpers");
class GoFileGenerator extends GoGenerator_1.GoGenerator {
    /**
    ...
    generateToFiles(input, outputDirectory, options, ensureFilesWritten = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const outputModel of generatedModels) {
                const fileName = helpers_1.FormatHelpers.toSnakeCase(outputModel.modelName);
...
exports.GoFileGenerator = GoFileGenerator;
//# sourceMappingURL=GoFileGenerator.js.map