...
exports.ScalaDefaultConstraints = exports.ScalaDefaultTypeMapping = void 0;
...
exports.ScalaDefaultTypeMapping = {
    ...
    Enum({ constrainedModel }) {
        const valueTypes = constrainedModel.values.map((enumValue) => fromEnumValueToKotlinType(enumValue, constrainedModel.options.format));
...
exports.ScalaDefaultConstraints = {
...
//# sourceMappingURL=ScalaConstrainer.js.map