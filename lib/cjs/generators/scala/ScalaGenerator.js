...
exports.ScalaGenerator = void 0;
const AbstractGenerator_1 = require("../AbstractGenerator");
const models_1 = require("../../models");
const helpers_1 = require("../../helpers");
const ScalaPreset_1 = require("./ScalaPreset");
...
const ScalaConstrainer_1 = require("./ScalaConstrainer");
const Partials_1 = require("../../utils/Partials");
const ScalaDependencyManager_1 = require("./ScalaDependencyManager");
/**
...
class ScalaGenerator extends AbstractGenerator_1.AbstractGenerator {
    constructor(options) {
     ...
     */
    static getScalaOptions(options) {
        const optionsToUse = (0, Partials_1.mergePartialAndDefault)(ScalaGenerator.defaultOptions, options);
        ...
        if ((options === null || options === void 0 ? void 0 : options.dependencyManager) === undefined) {
            optionsToUse.dependencyManager = () => {
                return new ScalaDependencyManager_1.ScalaDependencyManager(optionsToUse);
            };
        }
        return optionsToUse;
    }
    ...
    constrainToMetaModel(model, options) {
        const optionsToUse = ScalaGenerator.getScalaOptions(Object.assign(Object.assign({}, this.options), options));
     ...
     */
    render(args) {
        const optionsToUse = ScalaGenerator.getScalaOptions(Object.assign(Object.assign({}, this.options), args.options));
        ...
        __1.Logger.warn(`Scala generator, cannot generate this type of model, ${args.constrainedModel.name}`);
    ...
    renderCompleteModel(args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const packageName = this.sanitizePackageName((_a = args.completeOptions.packageName) !== null && _a !== void 0 ? _a : 'Asyncapi.Models');
...
${outputModel.result}`;
    ...
    sanitizePackageName(packageName) {
        return packageName
            .split('.')
            .map((subpackage) => (0, Constants_1.isReservedScalaKeyword)(subpackage, true)
            ? `\`${subpackage}\``
            : subpackage)
            .join('.');
    }
...
exports.ScalaGenerator = ScalaGenerator;
ScalaGenerator.defaultOptions = Object.assign(Object.assign({}, AbstractGenerator_1.defaultGeneratorOptions), { defaultPreset: ScalaPreset_1.SCALA_DEFAULT_PRESET, collectionType: 'List', typeMapping: ScalaConstrainer_1.ScalaDefaultTypeMapping, constraints: ScalaConstrainer_1.ScalaDefaultConstraints });
//# sourceMappingURL=ScalaGenerator.js.map