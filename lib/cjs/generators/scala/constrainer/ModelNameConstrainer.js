...
exports.DefaultModelNameConstraints = {
    ...
    NAMING_FORMATTER: (value) => {
        return helpers_1.FormatHelpers.toPascalCase(value);
    },
    NO_RESERVED_KEYWORDS: (value) => {
        return (0, Constraints_1.NO_RESERVED_KEYWORDS)(value, Constants_1.isReservedScalaKeyword);
    }
};
/**
 * Default constraint logic for Scala, which converts the model name into something that is compatible with Scala
 */
