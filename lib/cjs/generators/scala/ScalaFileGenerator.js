...
exports.ScalaFileGenerator = void 0;
const _1 = require(".");
const path = __importStar(require("path"));
const helpers_1 = require("../../helpers");
class ScalaFileGenerator extends _1.ScalaGenerator {
    /**
    ...
    generateToFiles(input, outputDirectory, options, ensureFilesWritten = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const outputModel of generatedModels) {
                const filePath = path.resolve(outputDirectory, `${outputModel.modelName}.scala`);
...
exports.ScalaFileGenerator = ScalaFileGenerator;
//# sourceMappingURL=ScalaFileGenerator.js.map