...
class RustGenerator extends AbstractGenerator_1.AbstractGenerator {
    ...
    render(args) {
        const optionsToUse = RustGenerator.getRustOptions(Object.assign(Object.assign({}, this.options), args.options));
        ...
        else if (args.constrainedModel instanceof models_1.ConstrainedTupleModel) {
            return this.renderTuple(args.constrainedModel, args.inputModel, optionsToUse);
        }
        ...
        LoggingInterface_1.Logger.warn(`Rust generator, cannot generate this type of model, ${args.constrainedModel.name}`);
