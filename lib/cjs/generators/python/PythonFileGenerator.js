...
exports.PythonFileGenerator = void 0;
const _1 = require(".");
const path = __importStar(require("path"));
const helpers_1 = require("../../helpers");
class PythonFileGenerator extends _1.PythonGenerator {
    /**
     ...
     */
    generateToFiles(input, outputDirectory, options, ensureFilesWritten = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const outputModel of generatedModels) {
                const filePath = path.resolve(outputDirectory, `${helpers_1.FormatHelpers.snakeCase(outputModel.modelName)}.py`);
                yield helpers_1.FileHelpers.writerToFileSystem(outputModel.result, filePath, ensureFilesWritten);
            }
            return generatedModels;
        });
    }
}
exports.PythonFileGenerator = PythonFileGenerator;
//# sourceMappingURL=PythonFileGenerator.js.map